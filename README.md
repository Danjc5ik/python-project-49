...
[![hexlet-check](https://github.com/Danjc5ik/python-project-49/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/Danjc5ik/python-project-49/actions)
...
```bash
git clone https://github.com/Danjc5ik/python-project-49.git
